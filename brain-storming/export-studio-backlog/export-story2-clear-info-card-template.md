...
## Story: "Clear Info" Card Template

**As a** user sharing my run,
**I want to** use a clean, frosted-glass "Clear Info" layout,
**So that** my core stats are highly readable over any background photo without fully obscuring the image.
