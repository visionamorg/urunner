...
## Story: "Cyberpunk Glitch Neon" Template

**As an** aggressive runner doing a night workout in the city,
...
- *Then* a CSS `text-shadow` effect (offsetting cyan and magenta colors) is applied to the distance text to simulate chromatic aberration / VHS color splitting.
