...
### Acceptance Criteria
- [ ] Admins see a new "Programmes" tab in the Community dashboard.
- [ ] Admin can create a Programme: Title, Description, Duration (e.g., 4 weeks), and Skill Level.
- [ ] Admin can add daily "Workouts" to the Programme (e.g., Week 1, Day 1: 5km Easy Run).
- [ ] Community members can view active programmes and click "Enroll". 
- [ ] Enrolled users have the programme's workouts injected into their personal running calendar.
- [ ] A progress bar/completion tracker is visible inside the Programme detail page showing enrolled members' compliance (e.g., "John Doe - 80% completed").
